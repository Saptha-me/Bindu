...
def downgrade() -> None:
    ...
    op.create_index(op.f('idx_tasks_updated_at'), 'tasks', [sa.literal_column('updated_at DESC')], unique=False)
    ...
    op.create_index(op.f('idx_task_feedback_created_at'), 'task_feedback', [sa.literal_column('created_at DESC')], unique=False)
    op.drop_index('idx_contexts_updated_at', table_name='contexts')
    op.create_index(op.f('idx_contexts_updated_at'), 'contexts', [sa.literal_column('updated_at DESC')], unique=False)
    op.drop_index('idx_contexts_created_at', table_name='contexts')
    op.create_index(op.f('idx_contexts_created_at'), 'contexts', [sa.literal_column('created_at DESC')], unique=False)
    # ### end Alembic commands ###
