...
class DockerApiClient:
    ...
    def create_api_client(self) -> Optional[Any]:
        ...
        try:
            ...
            print("Could not connect to docker. Please confirm docker is installed and running")
            print(e)
            print("Fix:")
            print("- If docker is running, please check output of `ls -l /var/run/docker.sock`.")
            print(
