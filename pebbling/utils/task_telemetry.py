...
task_counter = meter.create_counter(
    "pebbling_tasks_total",
    description="Total number of tasks processed",
    unit="1"
)

task_duration = meter.create_histogram(
    "pebbling_task_duration_seconds", 
    description="Task processing duration",
    unit="s"
)

active_tasks = meter.create_up_down_counter(
    "pebbling_active_tasks",
    description="Number of currently active tasks",
    unit="1"
)

context_counter = meter.create_counter(
    "pebbling_contexts_total",
    description="Total number of contexts managed",
    unit="1"
)
...
def create_task_span(task_id: UUID, operation: str, context_id: UUID | None = None):
    ...
    span.set_attributes({
        "pebbling.task_id": str(task_id),
        "pebbling.operation": operation,
        "pebbling.component": "task"
    })
