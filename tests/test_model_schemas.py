...
from pebbling.server.schemas.model import AgentResponse, AudioArtifact, ImageArtifact, MessageRole, VideoArtifact
...
class TestImageArtifact:
    ...
    def test_url_image(self):
        ...
        artifact = ImageArtifact(id=artifact_id, url="https://example.com/image.jpg", alt_text="Test image")
    ...
    def test_base64_image(self):
        ...
        artifact_id = uuid.uuid4()
        artifact = ImageArtifact(id=artifact_id, base64_image=base64_data)
    ...
    def test_get_content(self):
        ...
        # Create an artifact with base64 content
        artifact = ImageArtifact(id=uuid.uuid4(), base64_image=base64_data)
    ...
    def test_get_content_url(self):
        ...
        artifact = ImageArtifact(id=uuid.uuid4(), url="https://example.com/image.jpg")
...
class TestVideoArtifact:
    ...
    def test_url_video(self):
        ...
        # Create an artifact with a URL
        artifact_id = uuid.uuid4()
        artifact = VideoArtifact(id=artifact_id, url="https://example.com/video.mp4", caption="Test video")
    ...
    def test_base64_video(self):
        ...
        # Create an artifact with base64 content
        artifact_id = uuid.uuid4()
        artifact = VideoArtifact(id=artifact_id, base64_video=base64_data)
    ...
    def test_get_content(self):
        ...
        # Create an artifact with base64 content
        artifact = VideoArtifact(id=uuid.uuid4(), base64_video=base64_data)
...
class TestAudioArtifact:
    ...
    def test_url_audio(self):
        ...
        # Create an artifact with a URL
        artifact_id = uuid.uuid4()
        artifact = AudioArtifact(id=artifact_id, url="https://example.com/audio.mp3")
    ...
    def test_base64_audio(self):
        ...
        # Create an artifact with base64 content
        artifact_id = uuid.uuid4()
        artifact = AudioArtifact(id=artifact_id, base64_audio=base64_data)
    ...
    def test_validation_errors(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            AudioArtifact(id=uuid.uuid4(), url="https://example.com/audio.mp3", base64_audio="YXVkaW9fZGF0YQ==")
...
class TestAgentResponse:
    ...
    def test_response_metrics(self):
        ...
        response = AgentResponse(
            agent_id=agent_id, session_id=session_id, content="Test response", metrics={"tokens": 42, "time": 0.5}
        )
    ...
    def test_custom_role(self):
        ...
        response = AgentResponse(agent_id=agent_id, session_id=session_id, content="User input", role=MessageRole.USER)
