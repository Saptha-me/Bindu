...
class TestViewRequest:
    ...
    def test_view_request_validation_image(self):
        ...
        image = ImageArtifact(
            id=uuid.uuid4(), url="https://example.com/image.jpg", width=800, height=600, mime_type="image/jpeg"
        )
    ...
    def test_view_request_validation_mismatch(self):
        ...
        # Create valid image artifact
        image = ImageArtifact(id=uuid.uuid4(), url="https://example.com/image.jpg")
...
class TestResponseModels:
    ...
    def test_health_response(self):
        ...
        response = HealthResponse(
            status_code=200, status="healthy", message="Service is running", timestamp="2023-01-01T12:00:00Z"
        )
    ...
    def test_error_response(self):
        ...
        response = ErrorResponse(status_code=500, status="error", message="Something went wrong")
