...
class TestX402Utils:
    def test_build_payment_required_metadata(self):
        ...
        assert md[app_settings.x402.meta_status_key] == app_settings.x402.status_required
    ...
    def test_build_payment_verified_metadata(self):
        ...
        assert md[app_settings.x402.meta_status_key] == app_settings.x402.status_verified

    def test_build_payment_completed_metadata(self):
        receipt = {"tx": "0xabc"}
        md = build_payment_completed_metadata(receipt)
        assert md[app_settings.x402.meta_status_key] == app_settings.x402.status_completed
